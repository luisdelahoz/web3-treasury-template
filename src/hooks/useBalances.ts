...
import type { Entity, Group, NetworkKey, EntityState, BalancesMap, PricesMap, AssetRow } from '../types'
...
export function useBalances(groups: Group[], prices: PricesMap): UseBalancesResult {
  ...
  const loadEntity = useCallback(async (entity: Entity, groupId: string) => {
